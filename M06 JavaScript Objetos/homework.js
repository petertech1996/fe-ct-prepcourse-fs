...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   let cantidad = 0;
   let postDelUsuario = objetoUsuario.posts;

   for (let i = 0; i < postDelUsuario.length; i++) {
      console.log(postDelUsuario[i]);
      console.log(postDelUsuario[i].likes);
      cantidad += postDelUsuario[i].likes;
   }
   return cantidad;
}
